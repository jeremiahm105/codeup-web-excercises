...
//Solved without function and for loop
// let charCount = "big tuna"
//
// for(let i = 0; i < charCount.length; i++) {
//     console.log(`char iteration: ${charCount.charAt(i)}`)
// }


//solved with function and 2 inputs
// function charCount(input1, input2) {
//     let countString = 0;
//
...
// }
//
// console.log(charCount("b", "big fat double"));

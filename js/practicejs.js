...
//     if (color === "red"){
//         return "Red as in Apple"
//     } else if (color === "blue"){
//         return "Blue as in Sky"
//     } else if (color === "green") {
//         return "Grass as in Green"
//     } else if (color === "orange") {
//         return "Orange as in Orange"
//     } else {
...
//     } else if (lucky === 1) {
//         return "Your total after discount is $ " + (price - (price * .10))
//     } else if (lucky === 2) {
//         return "Your total after discount is $ " + (price - (price * .20))
//     } else if (lucky === 3) {
//         return "Your total after discount is $ " + (price - (price * .30))
//     } else if (lucky === 4) {
...
//
// //to calculate after discount i need price first so i get price - the discount equation
//
//
//
//
